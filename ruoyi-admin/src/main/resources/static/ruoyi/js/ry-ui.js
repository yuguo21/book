...
function initTextAreaTab(textarea, spaceCount = 8, cmdHandle){
    var func = function(event){
        ...
        if(event.code === "Tab"){
            ...
            let cmdKey = event.code;
            let tmpContent = textarea.value;
            tmpContent = tmpContent.replace("--", '');
            textarea.value = tmpContent;
            if (cmdHandle){
                cmdHandle(cmdKey);
